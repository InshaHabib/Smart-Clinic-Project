    ...
    <header className="sticky top-0 z-10 flex h-16 items-center justify-between border-b bg-card/80 backdrop-blur-lg px-6 shadow-sm animate-slide-in">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground animate-fade-in">Welcome back, Ilham</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              <Avatar className="transition-transform hover:scale-110">
                <AvatarImage src="/placeholder.svg?height=40&width=40" alt="Ilham Khan" />
          ...
          <DropdownMenuContent align="end" className="w-56 animate-scale-in">
            ...
            <DropdownMenuItem className="cursor-pointer hover:bg-primary/10">Settings</DropdownMenuItem>
            <DropdownMenuSeparator />
